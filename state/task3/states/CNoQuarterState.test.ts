...
import { CNoQuarterState } from "./CNoQuarterState";
...
describe("test NoQuarterState", () => {
    ...
    test("using refill method should invoke console.log and execute setGumsCount method of gumball machine", () => {
        ...
        const noQuarterState: IState = new CNoQuarterState(gumballMachine);

        noQuarterState.refill(2);
