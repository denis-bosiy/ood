...
import { CHasQuarterState } from "./CHasQuarterState";
...
describe("test HasQuarterState", () => {
    ...
    test("using refill method should invoke console.log and execute setGumsCount method of gumball machine", () => {
        ...
        const hasQuarterState: IState = new CHasQuarterState(gumballMachine);

        hasQuarterState.refill(2);
